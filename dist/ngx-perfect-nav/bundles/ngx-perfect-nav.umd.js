(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngx-perfect-nav'] = {}, global.ng.core, global.ng.common, global.ng.router));
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(NgxPerfectNavService, [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root'
                    }]
    ...
    function NgxPerfectNavComponent_ng_template_7_ng_container_0_div_1_Template(rf, ctx) {
        ...
        if (rf & 2) {
            var l_r7 = i0.ɵɵnextContext().$implicit;
    ...
    function NgxPerfectNavComponent_ng_template_9_div_3_Template(rf, ctx) {
        ...
        if (rf & 2) {
            var link_r11 = i0.ɵɵnextContext().link;
    ...
    function NgxPerfectNavComponent_ng_template_9_button_9_Template(rf, ctx) {
        if (rf & 1) {
            ...
            i0.ɵɵlistener("click", function NgxPerfectNavComponent_ng_template_9_button_9_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r27_1); var link_r11 = i0.ɵɵnextContext().link; var ctx_r25 = i0.ɵɵnextContext(); return ctx_r25.toggleChildren(link_r11); });
            i0.ɵɵelement(1, "span");
            i0.ɵɵelementEnd();
        }
    }
    ...
    var NgxPerfectNavComponent = /** @class */ (function () {
        function NgxPerfectNavComponent() {
            ...
            this.time = new Date();
            this.likeNotify = new i0.EventEmitter();
            this.shareNotify = new i0.EventEmitter();
            this.commentNotify = new i0.EventEmitter();
        }
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(NgxPerfectNavComponent, [{
                type: i0.Component,
                args: [{
    ...
    NgxPerfectNavModule.ɵmod = i0.ɵɵdefineNgModule({ type: NgxPerfectNavModule });
    NgxPerfectNavModule.ɵinj = i0.ɵɵdefineInjector({ factory: function NgxPerfectNavModule_Factory(t) { return new (t || NgxPerfectNavModule)(); }, imports: [[
                i1.CommonModule,
                i2.RouterModule
            ]] });
    (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(NgxPerfectNavModule, { declarations: [NgxPerfectNavComponent], imports: [i1.CommonModule,
                i2.RouterModule], exports: [NgxPerfectNavComponent] });
    })();
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(NgxPerfectNavModule, [{
                type: i0.NgModule,
                args: [{
